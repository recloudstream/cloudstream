...
import com.lagradost.cloudstream3.services.SyncRepoService
...
class PreferenceDelegate<T : Any>(
    ...
    operator fun getValue(self: Any?, property: KProperty<*>): T {
        if (localVersion != DataStore.globalVersion) {
            cache = null
            localVersion = DataStore.globalVersion
        }
...
object DataStore {
    ...
    fun Context.removeKey(path: String) {
        ...
        // Auto-sync on change
        SyncRepoService.scheduleSync(this)
    }
