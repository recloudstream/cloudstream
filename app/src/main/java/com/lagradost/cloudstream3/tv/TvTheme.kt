...
/**
 * Isolated cinematic dark high-contrast theme for the Compose-for-TV probe.
 * Uses only [androidx.tv.material3] — never phone Material3.
 */
private val TvProbeDarkColorScheme = darkColorScheme(
...
fun TvTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = TvProbeDarkColorScheme,
        content = content,
    )
}
