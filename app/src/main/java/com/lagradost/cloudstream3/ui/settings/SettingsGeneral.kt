...
val appLanguages = arrayListOf(
    ...
    Pair("Bahasa Indonesia", "id"), // "in" is deprecated, "id" <-> "in"
    ...
    Pair("русский", "ru"),
    Pair("українська", "uk"),
    Pair("עברית", "he"), // "iw" is deprecated, "he" <-> "iw"
    Pair("اردو", "ur"),
    Pair("العربية", "ar"),
    Pair("اللهجة النجدية", "ars"), // Arabic (Najdi)
    Pair("عربي شامي", "apc"), // "ajp" is deprecated, changed to "apc" Arabic (Shami / Levantine)
    Pair("فارسی", "fa"),
    Pair("ትግርኛ", "ti"),
    Pair("አማርኛ", "am"),
    Pair("नेपाली", "ne"),
