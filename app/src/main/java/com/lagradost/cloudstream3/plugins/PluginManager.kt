...
object PluginManager {
     ...
     * */
    private suspend fun loadPlugin(context: Context, file: File, data: PluginData, silent: Boolean = false): Boolean {
    ...
    suspend fun downloadPlugin(
        ...
        return downloadPlugin(activity, pluginUrl, internalName, file, loadPlugin, silent)
    }
    ...
    suspend fun ___DO_NOT_CALL_FROM_A_PLUGIN_manuallyReloadAndUpdatePlugins(activity: Activity, silent: Boolean = false) {
        assertNonRecursiveCallstack()
