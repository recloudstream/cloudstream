...
dependencies {
    ...
    dokkaImplementation(libs.media3.ui)
    dokkaImplementation(libs.media3.cast)
    dokkaImplementation(libs.media3.common)
    dokkaImplementation(libs.media3.session)
    dokkaImplementation(libs.media3.exoplayer)
    dokkaImplementation(libs.video)
    dokkaImplementation(libs.media3.exoplayer.hls)
    dokkaImplementation(libs.media3.exoplayer.dash)
    dokkaImplementation(libs.media3.datasource.okhttp)
    ...
    dokkaImplementation(libs.jackson.module.kotlin) {
        version {
            strictly("2.31.1")
        }
